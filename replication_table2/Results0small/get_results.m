...
for idx = 1:200
    % Construct file name
    filename = sprintf('C:/Users/YI/Desktop/RobustLR1030/Bankdata/Results0small/app_paraconasf_d0_cfsizevalue0_ind%d.mat', idx);
...
dat_small=dat_clean(banksize < bank_thresholds(1), :);
mean_values = mean(dat_small, 'omitnan');
