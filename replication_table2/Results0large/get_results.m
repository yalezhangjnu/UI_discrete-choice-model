...
for idx = 1:200
    % Construct file name
    filename = sprintf('C:/Users/YI/Desktop/RobustLR1030/Bankdata/Results0large/app_paraconasf_d0_cfsizevalue0_ind%d.mat', idx);
...
dat_median=dat_clean( banksize> bank_thresholds(2), :);
